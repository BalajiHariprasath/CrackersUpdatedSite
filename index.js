...
// Google Apps Script
function doPost(e) {
    const sheet = SpreadsheetApp.openById('1vbMWTCGZzBLmF4HcyQMbewVI5hwKpLwMIO6kEy0ZKBI').getSheetByName('Sheet1');
...
document.getElementById('login-form').addEventListener('submit', function(event) {
    ...
    if (name && mobile.match(/^[0-9]{10}$/)) {
        localStorage.setItem('loggedInUser', name); // Store logged-in user
        window.location.href = 'ProductDetails.html'; // Redirect to product cart page
    } else {
        document.getElementById('error-message').textContent = 'Invalid name or mobile number';
    }
});
